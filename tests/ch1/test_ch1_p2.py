...
from src.ch1.p2_permutation import isPermutation, isPermutationVer2
...
class TestIsPermutation(object):
    ...
    def test_one(self):
        ...
        assert isPermutationVer2(s1,s2) == True
    ...
    def test_same(self):
        ...
        assert isPermutationVer2(s1,s1) == True
        
    def test_differentLengths1(self):
        s1 = "goose"
        s2 = "soge"
        assert isPermutation(s1,s2) == False
        assert isPermutationVer2(s1,s2) == False
    ...
    def test_empty(self):
        s1 = ""
        assert isPermutation(s1,s1) == False
        assert isPermutationVer2(s1,s1) == False